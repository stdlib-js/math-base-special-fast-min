...
```javascript
min = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast-min@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast-min@umd/bundle.js"></script>
```
...
<html lang="en">
<body>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-base-minstd-shuffle@umd/bundle.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast-min@umd/bundle.js"></script>
<script type="text/javascript">
(function () {
