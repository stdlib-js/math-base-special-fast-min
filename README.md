...
```javascript
min = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast-min@v0.3.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast-min@v0.3.0-umd/browser.js"></script>
```
